...
SELECT city_name, state_abbreviation
 FROM city
 WHERE state_abbreviation <> 'CA' --same as !=
;
...
FROM park
WHERE area bETWEEN 100 AND 200 -- same as area area >= 20
;
...
--SELECT city_name, population, sales_tax  FROM state WHERE census_region = 'West';
SELECT city_name, area FROM city WHERE state_abbreviation = 'PA';
...
SELECT state_name, population, area, state_abbreviation  FROM state WHERE area>200000;
SELECT * FROM park;
...
SELECT * FROM state;
SELECT state_name, population, sales_tax FROM state WHERE sales_tax>6.6;
SELECT * FROM STATE;
SELECT state_name, state_nickname, sales_tax  FROM state WHERE census_region IN ('West', 'South') AND sales_tax!=0 ;
SELECT * FROM STATE;
SELECT park_name, date_established
FROM park
WHERE date_established BETWEEN '1960-01-01' AND '1960-12-12';
;
SELECT * FROM park;SELECT park_name, date_established FROM park ;
