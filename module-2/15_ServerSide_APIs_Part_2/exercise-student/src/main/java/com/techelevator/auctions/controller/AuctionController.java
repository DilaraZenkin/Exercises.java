...
public class AuctionController {
    ...
    public Auction update(@Valid @RequestBody Auction auction, @PathVariable(name="id") int id) throws AuctionNotFoundException {
    ...
    public void delete(@PathVariable(name="id") int id) throws AuctionNotFoundException {
        dao.delete(id);
    }
